...
local beginBlock_html = function(ttt)
  if ttt.options.collapse ~= "true" then
    local icons = {
      Definition = "book",
      Notation = "braces",
      Exercise = "pencil-square"
    }
    local icon = icons[ttt.type] or "bookmark"
    local bxstyle = " fobx-simplebox fobx-default fobx-static"
    return
      {pandoc.RawInline("html", '<div class=\"'..ttt.type..bxstyle..
        '\"><div class=\"fobx-title\"><i class=\"bi bi-'..icon..
        ' fobx-icon\" aria-hidden=\"true\"></i>')}..
      pandoctitle(ttt)..
      {pandoc.RawInline("html", '</div><div class=\"fobx-body\">')}
  end
