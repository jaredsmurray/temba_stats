...
Open the analysis organizer so I can arrange the required output for my report.
:::
...
The analysis organizer is ready.
:::
...
I selected P1 through P6 and T1 through T2 under **Weekly cheese sales and
promotional displays**. I selected T3 through T6 and P7 under **Hybrid work,
attrition, and productivity perceptions**. I kept them in the same order as the
homework and applied the changes. Prepare the Word report for review.
:::
...
Please approve this arrangement before I build the Word report.
:::
...
I approve this arrangement. Build the Word report.
:::
...
Built the [Homework 1 report skeleton](../files/homework-01-report-skeleton.docx).
:::
