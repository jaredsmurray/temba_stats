...
format:
  html:
    ...
    theme: cosmo
    css: homework-01-sample-chat.css
---
...
::: {.artifact}
![Histogram and density curve of weekly cheese sales.](homework-01-sample-chat-assets/01-overall-volume.png)
:::

Created **P2: Overall retail price**.

::: {.artifact}
![Histogram and density curve of retail price.](homework-01-sample-chat-assets/02-overall-price.png)
:::
...
::: {.artifact}
![Retail-price histogram with narrower bins.](homework-01-sample-chat-assets/03-overall-price-narrower-bins.png)
:::
:::
...
::: {.artifact}
![Weekly sales-volume distributions by display status.](homework-01-sample-chat-assets/04-volume-by-display.png)
:::
:::
...
::: {.artifact}
![Weekly sales-volume box plots by display status.](homework-01-sample-chat-assets/05-volume-boxplots.png)
:::
:::
...
::: {.artifact}
![Retail-price distributions by display status.](homework-01-sample-chat-assets/06-price-by-display.png)
:::
:::
...
::: {.artifact}
![Managers' baseline productivity perceptions in their natural order.](homework-01-sample-chat-assets/07-manager-perceptions.png)
:::
:::
